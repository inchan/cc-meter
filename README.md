...
<p align="center">
  <img src="docs/screenshots/popover.png" alt="CCMeter menubar label and popover" width="640">
</p>

> 메뉴바 라벨에는 활성 계정 이니셜, 5시간 세션 사용량 `S`, 7일 주간 사용량 `W` 가 표시됩니다. 라벨을 클릭하면 등록된 모든 계정의 사용량·리셋 시각·1-클릭 전환을 popover 로 제공합니다.
